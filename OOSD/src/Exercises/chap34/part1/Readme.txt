...
GUI:
//id frame
JFrameID = JLabel jlId ="ID"; JTextField tfId = ...; (9)

//will group lastname, firstname, mi
JFrame LastName = JLabel AND JTextField for last name (max 15)
JFrame FirstName = JLabel AND JTextField for first name (max 15)
JFrame mi = JLabel AND JTextField for mi (1)
JFrame name = GROUP ALL THE NAME FRAMES TOGETHER

//Address frame
JFrame Address = JLabel and JTextField for address (max 20)

//city and state frame
JFrame city = JLabel and JTextField for city (max 20)
JFrame state = JLabel and JTextField for state (2)
JFrame cityAndState = GROUP JLABELS FOR CITY AND STATE

//telephone frame
JFrame telephone = JLabel and JTextField for address (10)
...
//put everything in master frame
JFrame masterframe = GridLayout (7 rows, 1 columns)
